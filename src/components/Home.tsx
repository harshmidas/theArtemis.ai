  ...
  return (
    <div className="app">
        ...
        <div className="testimonials-grid">
          <div className="testimonial-card">
            ...
            <p className="testimonial-text">
              "Artemis gives us speed without chaos. Our time-to-submit dropped
              immediately."
            </p>
          </div>
          <div className="testimonial-card">
            ...
            <p className="testimonial-text">
              "The interface feels obvious. My team adopted it in a day—no long
              training calls."
            </p>
          </div>
          <div className="testimonial-card">
            ...
            <p className="testimonial-text">
              "Bulk parsing + RTR flows in one place—this is exactly what we
              needed."
            </p>
          </div>
        </div>
      ...
      <section className="about" id="about">
        <h2 className="section-title">About Artemis</h2>
        <p className="section-subtitle">
          Built for clarity and speed—be productive after a short walkthrough.
        </p>
        <div className="about-content">
          <div className="about-block">
            <h3>Our Mission</h3>
            <p>
              To make high-quality recruiting workflows accessible without
              enterprise bloat or surprise fees.
            </p>
          </div>
          <div className="about-block">
            <h3>Principles</h3>
